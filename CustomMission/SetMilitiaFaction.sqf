// private _fnc_scriptName = "CUSTOM_MISSION_fnc_SetMilitiaFaction";
...
TRGM_VAR_useCustomMilitiaFactionLoadouts = (["CustomMilitiaFactionLoadouts", 0] call BIS_fnc_getParamValue) isEqualTo 1;
publicVariable "TRGM_VAR_useCustomMilitiaFactionLoadouts";
