...
//////// Vehicle Spawning Leader Requirement ///////
TRGM_GETTER_fnc_bVehiclesLeadersOnly = { TRGM_VAR_AdvancedSettings select TRGM_VAR_ADVSET_VEHICLE_SPAWNING_REQ_LEADER_IDX isEqualTo 1; };
...
//////// Checkpoint Respawn Options ///////
TRGM_GETTER_fnc_bCheckpointRespawnEnabled = { TRGM_VAR_AdvancedSettings select TRGM_VAR_ADVSET_ENABLE_CHECKPOINT_RESPAWN_IDX isEqualTo 1; };
...
TRGM_VAR_MissionsThatHaveIntel = [1, 4, 5, 6, 14]; publicVariable "TRGM_VAR_MissionsThatHaveIntel";
